...
function get_svg( $args = array() ) {
  ...
  $aria_labelledby = '';
  // Set url to icons.
  $url_svg = get_stylesheet_directory_uri() . '/images/svg/symbol/sprite.svg';
  /*
   ...
   */
  $svg .= ' <use href="' . esc_url( $url_svg ) . '#icon-' . esc_html( $args['icon'] ) . '"; xlink:href="' . esc_url( $url_svg ) . '#' . esc_html( $args['icon'] ) . '"></use> ';
