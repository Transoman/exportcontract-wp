...
if ( ! function_exists( 'ith_setup' ) ) :
  ...
  function ith_setup() {
    ...
    register_nav_menus( array(
      ...
      'social-menu' => esc_html__( 'Меню соцсетей', 'ith' ),
    ) );
...
function ith_widgets_init() {
  ...
  register_sidebar( array(
    'name'          => esc_html__( 'Сайдбар услуги', 'ith' ),
    'id'            => 'services-sidebar',
    'description'   => esc_html__( 'Добавить виджеты здесь.', 'ith' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
 ...
 * Get services
 */
function get_services($count = null) {
...
/**
 * Example: [link href = http://site.com]Widget title[/link]
 */
...
/**
 * Enable TinyMCE editor to the post excerpt
 */
class TinyMceExcerptCustomization{
   ...
   */
  function __construct($contexts=array('post', 'page', 'services')){
